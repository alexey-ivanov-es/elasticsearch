...
- **Task 1.11:** `server/.../rest/action/admin/indices/RestDeleteIndexAction.java`, `RestGetIndicesAction.java` — deleted; replaced by generated RestIndicesDeleteAction, RestIndicesGetAction in restHandlers source set. RestClusterHealthAction and RestClusterGetSettingsAction are not part of the PoC and remain hand-written. RestPendingClusterTasksAction will be deleted when cluster.pending_tasks is generated and swapped (Task 1.11 for third PoC).
